...
public class ClientItemFrameInteractionHandler {
    ...
    public static EventResultHolder<InteractionResult> onAttackBlock(Player player, Level level, InteractionHand interactionHand, BlockPos pos, Direction direction) {
