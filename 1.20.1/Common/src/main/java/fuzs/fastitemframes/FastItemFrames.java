...
public class FastItemFrames implements ModConstructor {
    ...
    private static void registerEventHandlers() {
        ...
        ServerEntityLevelEvents.LOAD_V2.register(ItemFrameHandler::onEntityLoad);
    ...
    public void onCommonSetup() {
        CauldronInteraction.WATER.put(Items.ITEM_FRAME, ItemFrameHandler::itemFrameCauldronInteraction);
        CauldronInteraction.WATER.put(Items.GLOW_ITEM_FRAME, ItemFrameHandler::itemFrameCauldronInteraction);
    }
